...
<div class="breadcroumb-area metal-bg">
            ...
            <div class="service-details_sidebar">
                <div class="service-details_sidebar-service">
                    <ul class="service-details_sidebar-service-list list-unstyled">
                        ...
                        <li class="d-block current"><a href="{{ route('service6') }}">Service 6<span> <i class="las la-long-arrow-alt-right"></i></span></a></li>
                    </ul>
                </div>
        ...
        <div class="col-xl-8 col-lg-7">
            <div class="service-details_right">
                <div class="service-details_img">
                    <img src="{{asset('img2/service-details/metal_recycle.jpg')}}" alt="">
                    <div class="service-details_img-icon">
                        <img src="{{asset('img2/icon/metal.png')}}" alt="">
                    </div>
                </div>
                <div class="service-details_content">
                    <h3 class="service-details_title">Metal Recycling</h3>
                    <p class="service-details_text-1">In 2018, 19.2 million tons of ferrous metals (iron and steel) were generated. EPA estimates that the recycling rate of ferrous metals from durable goods was 27.8 percent. The same year, 2.5 million tons of nonferrous metals (not containing iron) were generated. The recycling rate for nonferrous metals was approximately 68 percent. </p>
