                ...
                <div class="service-details_sidebar">
                    <div class="service-details_sidebar-service">
                        <ul class="service-details_sidebar-service-list list-unstyled">
                            <li class="d-block current"><a href="{{ route('service1') }}">Service 1 <span> <i class="las la-long-arrow-alt-right"></i></span></a></li>
            ...
            <div class="col-xl-8 col-lg-7">
                <div class="service-details_right">
                    <div class="service-details_img">
                        <img src="{{asset('img2/service-details/paper_recycle.jpg')}}" alt="">
                        <div class="service-details_img-icon">
                            <img src="{{asset('img2/icon/paper.png')}}" alt="">
                        </div>
                    </div>
                    <div class="service-details_content">
                        <h3 class="service-details_title">Paper Recycling</h3>
                        <p class="service-details_text-1">Paper makes up 23 percent of municipal solid waste (trash) generated each year, more than any other material. Americans recycled about 68 percent of the paper they used in 2018. This recovered paper is used to make new paper products, which saves trees and other natural resources. Most community or office recycling programs accept paper and paper products.</p>
