...
@section('title', 'Vigilium - Employee')
                            ...
                            <tbody>
                                <tr>
                                    <td>
                                        <div class="table-img">
                                            <a href="profile.html">
                                                <img src="{{asset('img/profiles/avatar-13.jpg')}}" alt="profile"  class="img-table"/><label>Sean Black</label>
                                            </a>
                                        </div>
                                    </td>
                                    <td>
                                ...
                                <tr>
                                    <td>
                                        <div class="table-img">
                                            <a href="profile.html">
                                                <img src="{{asset('img/profiles/avatar-16.jpg')}}" alt="profile"  class="img-table"/><label>Linda Craver</label>
                                            </a>
                                        </div>
                                    </td>
                                    <td>
                                ...
                                <tr>
                                    <td>
                                        <div class="table-img">
                                            <a href="profile.html">
                                                <img src="{{asset('img/profiles/avatar-17.jpg')}}" alt="profile"  class="img-table"/>
                                            </a>
                                ...
                                <tr>
                                    <td>
                                        <div class="table-img">
                                            <a href="profile.html">
                                                <img src="{{asset('img/profiles/avatar-19.jpg')}}" alt="profile" class="img-table"/>
                                            </a>
                                ...
                                <tr>
                                    <td>
                                        <div class="table-img">
                                        <a href="profile.html">
                                            <img src="{{asset('img/profiles/avatar-14.jpg')}}" alt="profile" class="img-table"/>
                                        </a>
                                ...
                                <tr>
                                    <td>
                                        <div class="table-img">
                                            <a href="profile.html">
                                                <img src="{{asset('img/profiles/avatar-18.jpg')}}" alt="profile" class="img-table" />
                                            </a>
                                ...
                                <tr>
                                    <td>
                                        <div class="table-img">
                                            <a href="profile.html">
                                                <img src="{{asset('img/profiles/avatar-10.jpg')}}" alt="profile" class="img-table"/>
                                            </a>
