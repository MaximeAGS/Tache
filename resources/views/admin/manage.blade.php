            ...
            <div class="col-xl-12 col-sm-12 col-12 mb-4">
                <div class="head-link-set">
                    <ul>
                        ...
                        <li><a href="leadership-manage.html">Leadership Roles</a></li>
                    </ul>
                </div>
            </div>
            <div class="col-xl-12 col-sm-12 col-12 mb-4">
                                ...
                                <div class="card">
                                    <div class="card-header">
                                        <div class="employee-head">
                                            <h2>Super Admin</h2>
                                            <ul>
                                                <li><img src="{{asset('img/profiles/avatar-15.jpg')}}" alt="profile" class="img-table"/></li>
                                            </ul>
                                        </div>
                                    </div>
                                    <div class="card-body">
                                        <div class="employee-contents">
                                            ...
                                            <a class="btn-addmembers" href="super-admin.html">View Permission</a>
                                        </div>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="card">
                                    <div class="card-header">
                                        <div class="employee-head">
                                            <h2> Admin</h2>
                                            <ul>
                                                <li><img src="{{asset('img/profiles/avatar-14.jpg')}}" alt="profile" class="img-table" /></li>														</ul>
                                        </div>
                                    </div>
                                    <div class="card-body">
                                        <div class="employee-contents">
                                ...
                                <div class="card">
                                    <div class="card-header">
                                        <div class="employee-head">
                                            <h2>Payroll Admin</h2>
                                            <ul>
                                                <li><img src="{{asset('img/profiles/avatar-10.jpg')}}" alt="profile" class="img-table"/></li>														</ul>
                                        </div>
                                    </div>
                                    <div class="card-body">
                                        <div class="employee-contents">
                                ...
                                <div class="card">
                                    <div class="card-header">
                                        <div class="employee-head">
                                            <h2>Team Member</h2>
                                            <ul>
                                                <li><img src="{{asset('img/profiles/avatar-15.jpg')}}" alt="profile" class="img-table"/></li>														</ul>
                                        </div>
                                    </div>
                                    <div class="card-body">
                                        <div class="employee-contents">
