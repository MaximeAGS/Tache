        ...
        <div class="row">
                ...
                <div class="card flex-fill">
                    <div class="card-body">
                        <div class="employee_status text-center">
                            <img  alt="User Image" src="{{asset('img/profiles/avatar-17.jpg')}}">
            ...
            <div class="col-xl-3 col-sm-6 col-12 d-flex">
                <div class="card flex-fill">
                    <div class="card-body">
                        <div class="employee_status text-center">
                            <img  alt="User Image" src="{{asset('img/profiles/avatar-18.jpg')}}">
                            ...
                            <table class="table  custom-table  no-footer">
                                ...
                                <tbody>
                                    <tr>
                                        <td>
                                            <div class="table-img">
                                                <a href="profile.html"><img src="{{asset('img/profiles/avatar-13.jpg')}}" alt="profile" class="img-table"></a>
                                    ...
                                    <tr>
                                        <td>
                                            <div class="table-img">
                                                <a href="profile.html"><img src="{{asset('img/profiles/avatar-16.jpg')}}" alt="profile" class="img-table"></a>
