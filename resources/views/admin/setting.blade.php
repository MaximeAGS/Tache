...
@section('title', 'Vigilium - Setting')
                        ...
                        <div class="card card-lists flex-fill">
                            ...
                            <div class="card-body d-flex align-items-center">
                                <div class="member-img">
                                    <img src="{{asset('img/profiles/avatar-14.jpg')}}" alt="profile" class="mr-3">
                        ...
                        <div class="member-head employee-image">
                            ...
                            <div class="avatar-group">
                                <div class="avatar avatar-xs group_img group_header">
                                    <img class="avatar-img rounded-circle" alt="User Image" src="{{asset('img/profiles/avatar-10.jpg')}}">
                                </div>
                                <div class="avatar avatar-xs group_img group_header">
                                    <img class="avatar-img rounded-circle" alt="User Image" src="{{asset('img/profiles/avatar-15.jpg')}}">
                                </div>
                                <div class="avatar avatar-xs group_img group_header">
                                    <img class="avatar-img rounded-circle" alt="User Image" src="{{asset('img/profiles/avatar-16.jpg')}}">
                                </div>
                                <div class="avatar avatar-xs group_img group_header">
                                    <img class="avatar-img rounded-circle" alt="User Image" src="{{asset('img/profiles/avatar-17.jpg')}}">
                                </div>
                                <div class="avatar avatar-xs group_img group_header">
                                    <img class="avatar-img rounded-circle" alt="User Image" src="{{asset('img/profiles/avatar-14.jpg')}}">
                                </div>
                                <div class="avatar avatar-xs group_img group_header">
                                    <img class="avatar-img rounded-circle" alt="User Image" src="{{asset('img/profiles/avatar-18.jpg')}}">
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="card-body">
                                <div class="member-formcontent  border-0 ">
                                    <div class="member-imgs">
                                        <img src="{{asset('img/profiles/avatar-14.jpg')}}" alt="profile" />
                                        <div class="member-name">
                                            <label>Maria Cotton</label>
                                            <span><a href="https://dleohr.dreamstechnologies.com/cdn-cgi/l/email-protection" class="__cf_email__" data-cfemail="bad7dbc8d3dbd9d5ceced5d4fadfc2dbd7cad6df94d9d5d7">[email&#160;protected]</a></span>
                                        </div>
                                    </div>
    ...
    <div class="col-xl-9 col-sm-8 col-12">
        <div id="settingsContent">
            @switch($section)
                ...
                @case('detail')
                    @include('settings.detail')
                    {{-- @break
        
                @case('document')
                    @include('settings.document')
                    @break
