...
<div class="breadcroumb-area electronics-bg">
            ...
            <div class="service-details_sidebar">
                <div class="service-details_sidebar-service">
                    <ul class="service-details_sidebar-service-list list-unstyled">
                        ...
                        <li class="d-block "><a href="{{ route('service3') }}">Service 3<span> <i class="las la-long-arrow-alt-right"></i></span></a></li>
                        <li class="d-block"><a href="{{ route('service4') }}">Service 4<span> <i class="las la-long-arrow-alt-right"></i></span></a></li>
                        <li class="d-block current"><a href="{{ route('service5') }}">Service 5<span> <i class="las la-long-arrow-alt-right"></i></span></a></li>
        ...
        <div class="col-xl-8 col-lg-7">
            <div class="service-details_right">
                <div class="service-details_img">
                    <img src="{{asset('img2/service-details/electronics_recycle.jpg')}}" alt="">
                    <div class="service-details_img-icon">
                        <img src="{{asset('img2/icon/tv.png')}}" alt="">
                    </div>
                </div>
                <div class="service-details_content">
                    <h3 class="service-details_title">Electronics Recycling</h3>
                    <p class="service-details_text-1">EPA estimates that 2.7 million tons of consumer electronics were generated in 2018. About 38.5 percent of these electronics were recycled. Electronics cannot be recycled curbside, but they can be dropped off at specific collection sites. Manufacturers and retailers offer several options to donate or recycle electronics, including cell phones, computers, and televisions. </p>
